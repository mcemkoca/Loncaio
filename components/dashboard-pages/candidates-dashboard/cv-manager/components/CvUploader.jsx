            ...
            <div className="uploading-resume">
                <div className="uploadButton">
                    ...
                    <label className="cv-uploadButton" htmlFor="upload">
                        <span className="title">Yüklemek için dosyaları buraya bırakın</span>
                        <span className="text">
                            Dosya yüklemek için boyut (Maks. 5Mb) ve izin verilen dosya
                            türleri şunlardır (.doc, .docx, .pdf)
                        </span>
