        ...
        <div className="inner-box">
          <div className="content">
            ...
            <ul className="job-other-info">
              {company.isFeatured ? <li className="privacy">Öne Çıkanlar</li> : ""}

              <li className="time">Açık İş İlanları – {company.jobNumber}</li>
            </ul>
          </div>
    ...
    <>
      <div className="ls-switcher">
        <div className="showing-result">
          <div className="text">
            <strong>{content?.length}</strong> Isler
          </div>
        </div>
        {/* End showing-result */}
        ...
        <div className="sort-by">
          ...
          >
            <option value="">Sıralama ölçütü (varsayılan)</option>
